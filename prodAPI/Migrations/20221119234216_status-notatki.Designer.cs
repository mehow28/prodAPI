...
namespace prodAPI.Migrations
{
    ...
    [Migration("20221119234216_status-notatki")]
    partial class statusnotatki
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("prodAPI.Models.StrukturyWyrobuDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "IdEtapu" }, "IX_StrukturyWyrobu_IdEtapuNavigationIdEtapu");

                    b.HasIndex(new[] { "IdProduktu" }, "IX_StrukturyWyrobu_IdProduktuNavigationIdProduktu");

                    b.ToTable("StrukturyWyrobu", (string)null);
                });
